...
glabel func_003EAAD0
    ...
    /* 216454 003EAAD4 1000B0FF */  sd         $s0, 0x10($sp)
    /* 216458 003EAAD8 1800B1FF */  sd         $s1, 0x18($sp)
    /* 21645C 003EAADC 2D808000 */  daddu      $s0, $a0, $zero
    /* 216460 003EAAE0 2000BFFF */  sd         $ra, 0x20($sp)
    ...
    /* 216478 003EAAF8 3C00028E */  lw         $v0, 0x3C($s0)
    /* 21647C 003EAAFC 58004010 */  beqz       $v0, .L003EAC60
    /* 216480 003EAB00 01000724 */   addiu     $a3, $zero, 0x1
    /* 216484 003EAB04 0800028E */  lw         $v0, 0x8($s0)
    /* 216488 003EAB08 2D30A003 */  daddu      $a2, $sp, $zero
    /* 21648C 003EAB0C 2000438C */  lw         $v1, 0x20($v0)
    /* 216490 003EAB10 00B08044 */  mtc1       $zero, $f22
    /* 216494 003EAB14 09F86000 */  jalr       $v1
    /* 216498 003EAB18 2D880000 */   daddu     $s1, $zero, $zero
    /* 21649C 003EAB1C 2D200002 */  daddu      $a0, $s0, $zero
    /* 2164A0 003EAB20 E2A10F0C */  jal        func_003E8788
    /* 2164A4 003EAB24 2D28A003 */   daddu     $a1, $sp, $zero
    ...
    /* 2164B8 003EAB38 2D200002 */  daddu      $a0, $s0, $zero
    /* 2164BC 003EAB3C 0800A1C7 */  lwc1       $f1, 0x8($sp)
    /* 2164C0 003EAB40 40000524 */  addiu      $a1, $zero, 0x40
    ...
    /* 2164EC 003EAB6C 04004010 */  beqz       $v0, .L003EAB80
    /* 2164F0 003EAB70 60000FC6 */   lwc1      $f15, 0x60($s0)
    /* 2164F4 003EAB74 200016C6 */  lwc1       $f22, 0x20($s0)
    /* 2164F8 003EAB78 01001124 */  addiu      $s1, $zero, 0x1
    /* 2164FC 003EAB7C 240017C6 */  lwc1       $f23, 0x24($s0)
.align 2
  .L003EAB80:
    /* 216500 003EAB80 1E00013C */  lui        $at, %hi(D_001D96F4)
    /* 216504 003EAB84 F49620C4 */  lwc1       $f0, %lo(D_001D96F4)($at)
    /* 216508 003EAB88 5000049E */  lwu        $a0, 0x50($s0)
    /* 21650C 003EAB8C 02000F46 */  mul.s      $f0, $f0, $f15
    /* 216510 003EAB90 2800099E */  lwu        $t1, 0x28($s0)
    /* 216514 003EAB94 3C00058E */  lw         $a1, 0x3C($s0)
    /* 216518 003EAB98 1A002012 */  beqz       $s1, .L003EAC04
    /* 21651C 003EAB9C 5C000EC6 */   lwc1      $f14, 0x5C($s0)
    ...
    /* 216534 003EABB4 2D402002 */  daddu      $t0, $s1, $zero
    /* 216538 003EABB8 42A81046 */  mul.s      $f1, $f21, $f16
    /* 21653C 003EABBC 01000724 */  addiu      $a3, $zero, 0x1
...
.align 2
  .L003EAC04:
    ...
    /* 21659C 003EAC1C 01000724 */  addiu      $a3, $zero, 0x1
    /* 2165A0 003EAC20 2D400000 */  daddu      $t0, $zero, $zero
    ...
    /* 2165B4 003EAC34 00100244 */  mfc1       $v0, $f2
    /* 2165B8 003EAC38 24080046 */  .word      0x46000824                    # cvt.w.s    $f0, $f1 # 00000000 <InstrIdType: CPU_COP1_FPUS>
    /* 2165BC 003EAC3C 00000344 */  mfc1       $v1, $f0
    /* 2165C0 003EAC40 00608244 */  mtc1       $v0, $f12
    /* 2165C4 003EAC44 00000000 */  nop
    /* 2165C8 003EAC48 20638046 */  cvt.s.w    $f12, $f12
    /* 2165CC 003EAC4C 00688344 */  mtc1       $v1, $f13
    /* 2165D0 003EAC50 00000000 */  nop
    /* 2165D4 003EAC54 606B8046 */  cvt.s.w    $f13, $f13
    /* 2165D8 003EAC58 EE270E0C */  jal        func_00389FB8
    /* 2165DC 003EAC5C FFFF0624 */   addiu     $a2, $zero, -0x1
.align 2
  .L003EAC60:
    /* 2165E0 003EAC60 1000B0DF */  ld         $s0, 0x10($sp)
.align 2
  .L003EAC64:
    /* 2165E4 003EAC64 1800B1DF */  ld         $s1, 0x18($sp)
    /* 2165E8 003EAC68 2000BFDF */  ld         $ra, 0x20($sp)
    ...
    /* 216600 003EAC80 0800E003 */  jr         $ra
