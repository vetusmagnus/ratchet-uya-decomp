...
glabel func_003E3D08
    ...
    /* 20F68C 003E3D0C 0800B1FF */  sd         $s1, 0x8($sp)
    /* 20F690 003E3D10 1800B3FF */  sd         $s3, 0x18($sp)
    /* 20F694 003E3D14 2D888000 */  daddu      $s1, $a0, $zero
    /* 20F698 003E3D18 5800B9E7 */  swc1       $f25, 0x58($sp)
    /* 20F69C 003E3D1C 2D98A000 */  daddu      $s3, $a1, $zero
    ...
    /* 20F6C8 003E3D48 0000B0FF */  sd         $s0, 0x0($sp)
    /* 20F6CC 003E3D4C 1000B2FF */  sd         $s2, 0x10($sp)
    /* 20F6D0 003E3D50 2000BFFF */  sd         $ra, 0x20($sp)
    ...
    /* 20F6E4 003E3D64 2D904000 */  daddu      $s2, $v0, $zero
    /* 20F6E8 003E3D68 94870F0C */  jal        func_003E1E50
    /* 20F6EC 003E3D6C 2D202002 */   daddu     $a0, $s1, $zero
    /* 20F6F0 003E3D70 2B800200 */  sltu       $s0, $zero, $v0
    /* 20F6F4 003E3D74 2D286002 */  daddu      $a1, $s3, $zero
    /* 20F6F8 003E3D78 0A801200 */  movz       $s0, $zero, $s2
    /* 20F6FC 003E3D7C 028A0F0C */  jal        func_003E2808
    /* 20F700 003E3D80 2D202002 */   daddu     $a0, $s1, $zero
    /* 20F704 003E3D84 2B100200 */  sltu       $v0, $zero, $v0
    /* 20F708 003E3D88 06B30046 */  mov.s      $f12, $f22
    /* 20F70C 003E3D8C 46BB0046 */  mov.s      $f13, $f23
    /* 20F710 003E3D90 2D202002 */  daddu      $a0, $s1, $zero
    /* 20F714 003E3D94 228B0F0C */  jal        func_003E2C88
    /* 20F718 003E3D98 24800202 */   and       $s0, $s0, $v0
    /* 20F71C 003E3D9C 2B100200 */  sltu       $v0, $zero, $v0
    /* 20F720 003E3DA0 2D202002 */  daddu      $a0, $s1, $zero
    /* 20F724 003E3DA4 24800202 */  and        $s0, $s0, $v0
    /* 20F728 003E3DA8 06C30046 */  mov.s      $f12, $f24
    /* 20F72C 003E3DAC D0870F0C */  jal        func_003E1F40
    /* 20F730 003E3DB0 46CB0046 */   mov.s     $f13, $f25
    /* 20F734 003E3DB4 2B100200 */  sltu       $v0, $zero, $v0
    /* 20F738 003E3DB8 0800B1DF */  ld         $s1, 0x8($sp)
    /* 20F73C 003E3DBC 24100202 */  and        $v0, $s0, $v0
    /* 20F740 003E3DC0 1000B2DF */  ld         $s2, 0x10($sp)
    /* 20F744 003E3DC4 0000B0DF */  ld         $s0, 0x0($sp)
    /* 20F748 003E3DC8 1800B3DF */  ld         $s3, 0x18($sp)
    /* 20F74C 003E3DCC 2000BFDF */  ld         $ra, 0x20($sp)
    ...
    /* 20F768 003E3DE8 0800E003 */  jr         $ra
