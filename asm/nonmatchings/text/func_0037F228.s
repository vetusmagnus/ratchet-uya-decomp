...
glabel func_0037F228
    ...
    /* 1AABAC 0037F22C 5000B0FF */  sd         $s0, 0x50($sp)
    /* 1AABB0 0037F230 6000B2FF */  sd         $s2, 0x60($sp)
    /* 1AABB4 0037F234 6800B3FF */  sd         $s3, 0x68($sp)
    /* 1AABB8 0037F238 2D902001 */  daddu      $s2, $t1, $zero
    /* 1AABBC 0037F23C 7000B4FF */  sd         $s4, 0x70($sp)
    /* 1AABC0 0037F240 2D988000 */  daddu      $s3, $a0, $zero
    /* 1AABC4 0037F244 7800B5FF */  sd         $s5, 0x78($sp)
    /* 1AABC8 0037F248 2DA0E000 */  daddu      $s4, $a3, $zero
    /* 1AABCC 0037F24C A000B6E7 */  swc1       $f22, 0xA0($sp)
    /* 1AABD0 0037F250 2D20A003 */  daddu      $a0, $sp, $zero
    /* 1AABD4 0037F254 9000B4E7 */  swc1       $f20, 0x90($sp)
    /* 1AABD8 0037F258 2DA80001 */  daddu      $s5, $t0, $zero
    /* 1AABDC 0037F25C 5800B1FF */  sd         $s1, 0x58($sp)
    /* 1AABE0 0037F260 8000BFFF */  sd         $ra, 0x80($sp)
    /* 1AABE4 0037F264 A800B7E7 */  swc1       $f23, 0xA8($sp)
    /* 1AABE8 0037F268 9800B5E7 */  swc1       $f21, 0x98($sp)
    /* 1AABEC 0037F26C 0000C2D8 */  lqc2       $vf2, 0x0($a2)
    /* 1AABF0 0037F270 0000A1D8 */  lqc2       $vf1, 0x0($a1)
    /* 1AABF4 0037F274 6C08C24B */  vsub.xyz   $vf1, $vf1, $vf2
    /* 1AABF8 0037F278 2D284002 */  daddu      $a1, $s2, $zero
    /* 1AABFC 0037F27C 0000A1FB */  sqc2       $vf1, 0x0($sp)
    /* 1AAC00 0037F280 00B08044 */  mtc1       $zero, $f22
    /* 1AAC04 0037F284 CC210E0C */  jal        func_00388730
    /* 1AAC08 0037F288 00000000 */   nop
    /* 1AAC0C 0037F28C 1000A427 */  addiu      $a0, $sp, 0x10
    /* 1AAC10 0037F290 06030046 */  mov.s      $f12, $f0
    /* 1AAC14 0037F294 0C220E0C */  jal        func_00388830
    /* 1AAC18 0037F298 2D284002 */   daddu     $a1, $s2, $zero
    /* 1AAC1C 0037F29C 0000A1DB */  lqc2       $vf1, 0x0($sp)
    /* 1AAC20 0037F2A0 1000A2DB */  lqc2       $vf2, 0x10($sp)
    /* 1AAC24 0037F2A4 2000B027 */  addiu      $s0, $sp, 0x20
    /* 1AAC28 0037F2A8 6C08C24B */  vsub.xyz   $vf1, $vf1, $vf2
    /* 1AAC2C 0037F2AC 2D208002 */  daddu      $a0, $s4, $zero
    /* 1AAC30 0037F2B0 2D280002 */  daddu      $a1, $s0, $zero
    /* 1AAC34 0037F2B4 2000A1FB */  sqc2       $vf1, 0x20($sp)
    ...
    /* 1AAC48 0037F2C8 2D200002 */   daddu     $a0, $s0, $zero
...
.align 2
  .L0037F2E8:
    ...
    /* 1AAC90 0037F310 3000B127 */  addiu      $s1, $sp, 0x30
    /* 1AAC94 0037F314 01AD0046 */  sub.s      $f20, $f21, $f0
    /* 1AAC98 0037F318 2D280002 */  daddu      $a1, $s0, $zero
    /* 1AAC9C 0037F31C 2D202002 */  daddu      $a0, $s1, $zero
    /* 1AACA0 0037F320 0C220E0C */  jal        func_00388830
    /* 1AACA4 0037F324 06BB0046 */   mov.s     $f12, $f23
    /* 1AACA8 0037F328 2D20A002 */  daddu      $a0, $s5, $zero
    /* 1AACAC 0037F32C CC210E0C */  jal        func_00388730
    /* 1AACB0 0037F330 2D282002 */   daddu     $a1, $s1, $zero
...
.align 2
  .L0037F344:
    /* 1AACC4 0037F344 4000B027 */  addiu      $s0, $sp, 0x40
    /* 1AACC8 0037F348 000074E6 */  swc1       $f20, 0x0($s3)
    /* 1AACCC 0037F34C 06A30046 */  mov.s      $f12, $f20
    /* 1AACD0 0037F350 2D304002 */  daddu      $a2, $s2, $zero
    /* 1AACD4 0037F354 2D288002 */  daddu      $a1, $s4, $zero
    /* 1AACD8 0037F358 56240E0C */  jal        func_00389158
    /* 1AACDC 0037F35C 2D200002 */   daddu     $a0, $s0, $zero
    /* 1AACE0 0037F360 2D200002 */  daddu      $a0, $s0, $zero
    /* 1AACE4 0037F364 CC210E0C */  jal        func_00388730
    /* 1AACE8 0037F368 2D28A003 */   daddu     $a1, $sp, $zero
    /* 1AACEC 0037F36C 06050046 */  mov.s      $f20, $f0
    /* 1AACF0 0037F370 DC210E0C */  jal        func_00388770
    /* 1AACF4 0037F374 2D20A003 */   daddu     $a0, $sp, $zero
...
.align 2
  .L0037F394:
    ...
    /* 1AAD2C 0037F3AC 2D28A003 */  daddu      $a1, $sp, $zero
    /* 1AAD30 0037F3B0 06BB0046 */  mov.s      $f12, $f23
    /* 1AAD34 0037F3B4 0C220E0C */  jal        func_00388830
    /* 1AAD38 0037F3B8 2D202002 */   daddu     $a0, $s1, $zero
    /* 1AAD3C 0037F3BC 2D204002 */  daddu      $a0, $s2, $zero
    /* 1AAD40 0037F3C0 CC210E0C */  jal        func_00388730
    /* 1AAD44 0037F3C4 2D282002 */   daddu     $a1, $s1, $zero
...
.align 2
  .L0037F3DC:
    /* 1AAD5C 0037F3DC 040074E6 */  swc1       $f20, 0x4($s3)
    /* 1AAD60 0037F3E0 DC210E0C */  jal        func_00388770
    /* 1AAD64 0037F3E4 2D20A003 */   daddu     $a0, $sp, $zero
    /* 1AAD68 0037F3E8 080060E6 */  swc1       $f0, 0x8($s3)
    /* 1AAD6C 0037F3EC 5000B0DF */  ld         $s0, 0x50($sp)
    /* 1AAD70 0037F3F0 5800B1DF */  ld         $s1, 0x58($sp)
    /* 1AAD74 0037F3F4 6000B2DF */  ld         $s2, 0x60($sp)
    /* 1AAD78 0037F3F8 6800B3DF */  ld         $s3, 0x68($sp)
    /* 1AAD7C 0037F3FC 7000B4DF */  ld         $s4, 0x70($sp)
    /* 1AAD80 0037F400 7800B5DF */  ld         $s5, 0x78($sp)
    /* 1AAD84 0037F404 8000BFDF */  ld         $ra, 0x80($sp)
    ...
    /* 1AAD98 0037F418 0800E003 */  jr         $ra
