...
glabel func_0039B240
    ...
    /* 1C6BC8 0039B248 800026AC */  sw         $6, 0x80($at)
    /* 1C6BCC 0039B24C 200025AC */  sw         $5, 0x20($at)
.align 2
  .L0039B250:
    /* 1C6BD0 0039B250 100024AC */  sw         $4, 0x10($at)
    /* 1C6BD4 0039B254 00010234 */  ori        $2, $0, 0x100
    /* 1C6BD8 0039B258 0800E003 */  jr         $31
    /* 1C6BDC 0039B25C 000022AC */   sw        $2, 0x0($at)
    ...
    /* 1C6C08 0039B288 0000228C */  lw         $2, 0x0($at)
    /* 1C6C0C 0039B28C 00000000 */  nop
    /* 1C6C10 0039B290 00000000 */  nop
    /* 1C6C14 0039B294 00000000 */  nop
    /* 1C6C18 0039B298 00014230 */  andi       $2, $2, 0x100
    /* 1C6C1C 0039B29C 00000000 */  nop
    /* 1C6C20 0039B2A0 03004010 */  beqz       $2, .L0039B2B0
...
.align 2
  .L0039B2B0:
    /* 1C6C30 0039B2B0 0800E003 */  jr         $31
    /* 1C6C34 0039B2B4 00000000 */   nop
    /* 1C6C38 0039B2B8 00012931 */  andi       $9, $9, 0x100
    /* 1C6C3C 0039B2BC 00000000 */  nop
    /* 1C6C40 0039B2C0 F9FF2015 */  .word 0x1520FFF9 /* bnez $9, .L0039B2A8 -- raw so ee-as can't pad the short loop */
    /* 1C6C44 0039B2C4 00000000 */   nop
    /* 1C6C48 0039B2C8 E1FFC01C */  bgtz       $6, .L0039B250
    /* 1C6C4C 0039B2CC 00000000 */   nop
    /* 1C6C50 0039B2D0 0800E003 */  jr         $31
