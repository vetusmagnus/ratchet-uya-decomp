...
glabel func_003B8280
    ...
    /* 1E3C04 003B8284 1E00053C */  lui        $5, %hi(D_001DA330)
    /* 1E3C08 003B8288 30A3A58C */  lw         $5, %lo(D_001DA330)($5)
    /* 1E3C0C 003B828C 1E00013C */  lui        $at, %hi(D_001DA334)
    /* 1E3C10 003B8290 34A32CC4 */  lwc1       $f12, %lo(D_001DA334)($at)
    /* 1E3C14 003B8294 1E00043C */  lui        $4, %hi(D_001DA320)
    /* 1E3C18 003B8298 20A38424 */  addiu      $4, $4, %lo(D_001DA320)
    /* 1E3C1C 003B829C 1E00013C */  lui        $at, %hi(D_001DA338)
    /* 1E3C20 003B82A0 38A32DC4 */  lwc1       $f13, %lo(D_001DA338)($at)
    /* 1E3C24 003B82A4 0000BFFF */  sd         $31, 0x0($sp)
    /* 1E3C28 003B82A8 BCFF0E0C */  jal        func_003BFEF0
    /* 1E3C2C 003B82AC 00000000 */   nop
    /* 1E3C30 003B82B0 0000BFDF */  ld         $31, 0x0($sp)
    /* 1E3C34 003B82B4 0800E003 */  jr         $31
