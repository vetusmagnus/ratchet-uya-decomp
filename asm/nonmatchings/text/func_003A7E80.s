...
glabel func_003A7E80
    ...
    /* 1D3810 003A7E90 0000B0FF */  sd         $s0, 0x0($sp)
    /* 1D3814 003A7E94 2D280000 */  daddu      $a1, $zero, $zero
    /* 1D3818 003A7E98 2D808000 */  daddu      $s0, $a0, $zero
    /* 1D381C 003A7E9C 0800BFFF */  sd         $ra, 0x8($sp)
    /* 1D3820 003A7EA0 1000B4E7 */  swc1       $f20, 0x10($sp)
    /* 1D3824 003A7EA4 180000AE */  sw         $zero, 0x18($s0)
    /* 1D3828 003A7EA8 280000A2 */  sb         $zero, 0x28($s0)
    /* 1D382C 003A7EAC 180014C6 */  lwc1       $f20, 0x18($s0)
    /* 1D3830 003A7EB0 2C0000AE */  sw         $zero, 0x2C($s0)
    /* 1D3834 003A7EB4 800000AE */  sw         $zero, 0x80($s0)
    /* 1D3838 003A7EB8 06A30046 */  mov.s      $f12, $f20
    /* 1D383C 003A7EBC 240000E6 */  swc1       $f0, 0x24($s0)
    ...
    /* 1D385C 003A7EDC 2D200002 */  daddu      $a0, $s0, $zero
    /* 1D3860 003A7EE0 01000524 */  addiu      $a1, $zero, 0x1
    ...
    /* 1D387C 003A7EFC 02000224 */  addiu      $v0, $zero, 0x2
    /* 1D3880 003A7F00 840002AE */  sw         $v0, 0x84($s0)
    /* 1D3884 003A7F04 2D200002 */  daddu      $a0, $s0, $zero
    /* 1D3888 003A7F08 2D280000 */  daddu      $a1, $zero, $zero
    /* 1D388C 003A7F0C F29F0E0C */  jal        func_003A7FC8
    /* 1D3890 003A7F10 46630046 */   mov.s     $f13, $f12
    /* 1D3894 003A7F14 01000224 */  addiu      $v0, $zero, 0x1
    /* 1D3898 003A7F18 200000AE */  sw         $zero, 0x20($s0)
    /* 1D389C 003A7F1C 1C0002AE */  sw         $v0, 0x1C($s0)
    /* 1D38A0 003A7F20 0000B0DF */  ld         $s0, 0x0($sp)
    /* 1D38A4 003A7F24 0800BFDF */  ld         $ra, 0x8($sp)
    /* 1D38A8 003A7F28 1000B4C7 */  lwc1       $f20, 0x10($sp)
    /* 1D38AC 003A7F2C 0800E003 */  jr         $ra
