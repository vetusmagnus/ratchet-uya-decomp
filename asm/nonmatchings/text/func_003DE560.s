...
glabel func_003DE560
    ...
    /* 209EF4 003DE574 3000B0FF */  sd         $16, 0x30($sp)
    /* 209EF8 003DE578 34600046 */  c.lt.s     $f12, $f0
    /* 209EFC 003DE57C 3800B1FF */  sd         $17, 0x38($sp)
    /* 209F00 003DE580 4000B2FF */  sd         $18, 0x40($sp)
    /* 209F04 003DE584 4800B3FF */  sd         $19, 0x48($sp)
    /* 209F08 003DE588 5000B4FF */  sd         $20, 0x50($sp)
    /* 209F0C 003DE58C 5800B5FF */  sd         $21, 0x58($sp)
    /* 209F10 003DE590 6000BFFF */  sd         $31, 0x60($sp)
...
.align 2
  .L003DE5BC:
    ...
    /* 209F48 003DE5C8 3000033C */   lui       $3, %hi(D_00302E30)
.align 2
  .L003DE5CC:
    /* 209F4C 003DE5CC 3000033C */  lui        $3, %hi(D_00302E30)
.align 2
  .L003DE5D0:
    /* 209F50 003DE5D0 2200043C */  lui        $4, %hi(D_00222480)
    /* 209F54 003DE5D4 302E6224 */  addiu      $2, $3, %lo(D_00302E30)
    /* 209F58 003DE5D8 802481D8 */  lqc2       $vf1, %lo(D_00222480)($4)
    /* 209F5C 003DE5DC F0FF4224 */  addiu      $2, $2, -0x10
    /* 209F60 003DE5E0 302E62D8 */  lqc2       $vf2, %lo(D_00302E30)($3)
    /* 209F64 003DE5E4 6C08C24B */  vsub.xyz   $vf1, $vf1, $vf2
    /* 209F68 003DE5E8 54004CC4 */  lwc1       $f12, 0x54($2)
    /* 209F6C 003DE5EC 2D988000 */  daddu      $19, $4, $0
    /* 209F70 003DE5F0 30005224 */  addiu      $18, $2, 0x30
    .word 0xFBA10000 /* .word 0xFBA10000 */
    /* 209F78 003DE5F8 2D20A003 */  daddu      $4, $sp, $0
    ...
    /* 209F8C 003DE60C 2D28A003 */   daddu     $5, $sp, $0
    /* 209F90 003DE610 2041013C */  lui        $at, (0x41200000 >> 16)
    /* 209F94 003DE614 00A08144 */  mtc1       $at, $f20
    /* 209F98 003DE618 2000B527 */  addiu      $21, $sp, 0x20
    /* 209F9C 003DE61C 1000B427 */  addiu      $20, $sp, 0x10
    /* 209FA0 003DE620 2D880000 */  daddu      $17, $0, $0
    /* 209FA4 003DE624 00000000 */  nop
.align 2
  .L003DE628:
    /* 209FA8 003DE628 00609144 */  mtc1       $17, $f12
    /* 209FAC 003DE62C 00000000 */  nop
    /* 209FB0 003DE630 20638046 */  cvt.s.w    $f12, $f12
    /* 209FB4 003DE634 01003026 */  addiu      $16, $17, 0x1
    ...
    /* 209FC8 003DE648 2D880002 */   daddu     $17, $16, $0
    /* 209FCC 003DE64C 06030046 */  mov.s      $f12, $f0
    /* 209FD0 003DE650 2D28A003 */  daddu      $5, $sp, $0
    /* 209FD4 003DE654 2D20A002 */  daddu      $4, $21, $0
    /* 209FD8 003DE658 56240E0C */  jal        func_00389158
    /* 209FDC 003DE65C 2D304002 */   daddu     $6, $18, $0
    /* 209FE0 003DE660 00609044 */  mtc1       $16, $f12
    /* 209FE4 003DE664 00000000 */  nop
    /* 209FE8 003DE668 20638046 */  cvt.s.w    $f12, $f12
    .word 0xDA41FFE0 /* .word 0xDA41FFE0 */
    ...
    /* 20A018 003DE698 2D208002 */  daddu      $4, $20, $0
    /* 20A01C 003DE69C 2D28A003 */  daddu      $5, $sp, $0
    /* 20A020 003DE6A0 56240E0C */  jal        func_00389158
    /* 20A024 003DE6A4 2D304002 */   daddu     $6, $18, $0
    .word 0xDBA20010 /* .word 0xDBA20010 */
    .word 0xDA41FFE0 /* .word 0xDA41FFE0 */
    /* 20A030 003DE6B0 A810C14B */  vadd.xyz   $vf2, $vf2, $vf1
    /* 20A034 003DE6B4 0A00222A */  slti       $2, $17, 0xA
    .word 0xFBA20010 /* .word 0xFBA20010 */
    /* 20A03C 003DE6BC DAFF4014 */  bnez       $2, .L003DE628
    /* 20A040 003DE6C0 00000000 */   nop
    /* 20A044 003DE6C4 287A0F0C */  jal        func_003DE8A0
    /* 20A048 003DE6C8 00000000 */   nop
    /* 20A04C 003DE6CC 5C004050 */  beql       $2, $0, .L003DE840
    /* 20A050 003DE6D0 3000B0DF */   ld        $16, 0x30($sp)
    /* 20A054 003DE6D4 1D00023C */  lui        $2, (0x1D5474 >> 16)
    /* 20A058 003DE6D8 74544290 */  lbu        $2, (0x1D5474 & 0xFFFF)($2)
    /* 20A05C 003DE6DC 57004010 */  beqz       $2, .L003DE83C
    /* 20A060 003DE6E0 D0FF4626 */   addiu     $6, $18, -0x30
    /* 20A064 003DE6E4 5000C28C */  lw         $2, 0x50($6)
    /* 20A068 003DE6E8 55004014 */  bnez       $2, .L003DE840
    /* 20A06C 003DE6EC 3000B0DF */   ld        $16, 0x30($sp)
    /* 20A070 003DE6F0 4800C1C4 */  lwc1       $f1, 0x48($6)
    ...
    /* 20A090 003DE710 4800C0E4 */   swc1      $f0, 0x48($6)
    ...
    /* 20A0AC 003DE72C 4800C0E4 */  swc1       $f0, 0x48($6)
.align 2
  .L003DE730:
    /* 20A0B0 003DE730 3000023C */  lui        $2, %hi(D_00302E20)
    ...
    /* 20A0C0 003DE740 202E5024 */  addiu      $16, $2, %lo(D_00302E20)
    ...
    /* 20A0D0 003DE750 480000C6 */  lwc1       $f0, 0x48($16)
    /* 20A0D4 003DE754 400004C6 */  lwc1       $f4, 0x40($16)
    /* 20A0D8 003DE758 00000000 */  nop
    /* 20A0DC 003DE75C 00000000 */  nop
    /* 20A0E0 003DE760 C3000346 */  div.s      $f3, $f0, $f3
    /* 20A0E4 003DE764 540001C6 */  lwc1       $f1, 0x54($16)
    ...
    /* 20A0FC 003DE77C 4C0003E6 */   swc1      $f3, 0x4C($16)
    ...
    /* 20A110 003DE790 802461DA */  lqc2       $vf1, %lo(D_00222480)($19)
    /* 20A114 003DE794 80246426 */  addiu      $4, $19, %lo(D_00222480)
    /* 20A118 003DE798 02180046 */  mul.s      $f0, $f3, $f0
    /* 20A11C 003DE79C 6C08C24B */  vsub.xyz   $vf1, $vf1, $vf2
    /* 20A120 003DE7A0 802461FA */  sqc2       $vf1, %lo(D_00222480)($19)
    /* 20A124 003DE7A4 2D288000 */  daddu      $5, $4, $0
    ...
    /* 20A138 003DE7B8 400000E6 */   swc1      $f0, 0x40($16)
    /* 20A13C 003DE7BC 802461DA */  lqc2       $vf1, %lo(D_00222480)($19)
    .word 0xDA020010 /* .word 0xDA020010 */
    /* 20A144 003DE7C4 6808C24B */  vadd.xyz   $vf1, $vf1, $vf2
    /* 20A148 003DE7C8 802461FA */  sqc2       $vf1, %lo(D_00222480)($19)
.align 2
  .L003DE7CC:
    /* 20A14C 003DE7CC 48000CC6 */  lwc1       $f12, 0x48($16)
    .word 0xDA020010 /* .word 0xDA020010 */
    /* 20A154 003DE7D4 440000C6 */  lwc1       $f0, 0x44($16)
    /* 20A158 003DE7D8 802461DA */  lqc2       $vf1, %lo(D_00222480)($19)
    /* 20A15C 003DE7DC 02B30C46 */  mul.s      $f12, $f22, $f12
    /* 20A160 003DE7E0 6C08C24B */  vsub.xyz   $vf1, $vf1, $vf2
    /* 20A164 003DE7E4 80246426 */  addiu      $4, $19, %lo(D_00222480)
    /* 20A168 003DE7E8 30000626 */  addiu      $6, $16, 0x30
    /* 20A16C 003DE7EC 2D288000 */  daddu      $5, $4, $0
    /* 20A170 003DE7F0 802461FA */  sqc2       $vf1, %lo(D_00222480)($19)
    /* 20A174 003DE7F4 56240E0C */  jal        func_00389158
    /* 20A178 003DE7F8 02630046 */   mul.s     $f12, $f12, $f0
    /* 20A17C 003DE7FC 4C0000C6 */  lwc1       $f0, 0x4C($16)
    /* 20A180 003DE800 802462DA */  lqc2       $vf2, %lo(D_00222480)($19)
    ...
    /* 20A198 003DE818 1A00063C */  lui        $6, %hi(D_1A4C60)
    /* 20A19C 003DE81C 02030C46 */  mul.s      $f12, $f0, $f12
    /* 20A1A0 003DE820 2D200002 */  daddu      $4, $16, $0
    /* 20A1A4 003DE824 802462FA */  sqc2       $vf2, %lo(D_00222480)($19)
    /* 20A1A8 003DE828 604CC624 */  addiu      $6, $6, %lo(D_1A4C60)
    /* 20A1AC 003DE82C B0210E0C */  jal        func_003886C0
    /* 20A1B0 003DE830 2D280002 */   daddu     $5, $16, $0
    /* 20A1B4 003DE834 28790F0C */  jal        func_003DE4A0
    /* 20A1B8 003DE838 2D200002 */   daddu     $4, $16, $0
.align 2
  .L003DE83C:
    /* 20A1BC 003DE83C 3000B0DF */  ld         $16, 0x30($sp)
.align 2
  .L003DE840:
    /* 20A1C0 003DE840 3800B1DF */  ld         $17, 0x38($sp)
    /* 20A1C4 003DE844 4000B2DF */  ld         $18, 0x40($sp)
    /* 20A1C8 003DE848 4800B3DF */  ld         $19, 0x48($sp)
    /* 20A1CC 003DE84C 5000B4DF */  ld         $20, 0x50($sp)
    /* 20A1D0 003DE850 5800B5DF */  ld         $21, 0x58($sp)
    /* 20A1D4 003DE854 6000BFDF */  ld         $31, 0x60($sp)
    ...
    /* 20A1E4 003DE864 0800E003 */  jr         $31
