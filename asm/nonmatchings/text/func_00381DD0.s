...
glabel func_00381DD0
    ...
    /* 1AD754 00381DD4 A800B1FF */  sd         $s1, 0xA8($sp)
    /* 1AD758 00381DD8 B800B3FF */  sd         $s3, 0xB8($sp)
    /* 1AD75C 00381DDC 2D888000 */  daddu      $s1, $a0, $zero
    /* 1AD760 00381DE0 A000B0FF */  sd         $s0, 0xA0($sp)
    /* 1AD764 00381DE4 2D20A003 */  daddu      $a0, $sp, $zero
    /* 1AD768 00381DE8 B000B2FF */  sd         $s2, 0xB0($sp)
    /* 1AD76C 00381DEC 2D98A000 */  daddu      $s3, $a1, $zero
    /* 1AD770 00381DF0 C000BFFF */  sd         $ra, 0xC0($sp)
    ...
    /* 1AD784 00381E04 2200023C */  lui        $v0, %hi(D_00222340)
    /* 1AD788 00381E08 4000B227 */  addiu      $s2, $sp, 0x40
    /* 1AD78C 00381E0C 40234224 */  addiu      $v0, $v0, %lo(D_00222340)
    /* 1AD790 00381E10 2D30A003 */  daddu      $a2, $sp, $zero
    /* 1AD794 00381E14 400142C4 */  lwc1       $f2, 0x140($v0)
    /* 1AD798 00381E18 40004524 */  addiu      $a1, $v0, 0x40
    /* 1AD79C 00381E1C 440141C4 */  lwc1       $f1, 0x144($v0)
    /* 1AD7A0 00381E20 2D204002 */  daddu      $a0, $s2, $zero
    /* 1AD7A4 00381E24 480140C4 */  lwc1       $f0, 0x148($v0)
    ...
    /* 1AD7D0 00381E50 8000B027 */  addiu      $s0, $sp, 0x80
    /* 1AD7D4 00381E54 06A30046 */  mov.s      $f12, $f20
    /* 1AD7D8 00381E58 2D286002 */  daddu      $a1, $s3, $zero
    /* 1AD7DC 00381E5C BA210E0C */  jal        func_003886E8
    /* 1AD7E0 00381E60 2D200002 */   daddu     $a0, $s0, $zero
    /* 1AD7E4 00381E64 803F013C */  lui        $at, (0x3F800000 >> 16)
    /* 1AD7E8 00381E68 00008144 */  mtc1       $at, $f0
    /* 1AD7EC 00381E6C 2D280002 */  daddu      $a1, $s0, $zero
    /* 1AD7F0 00381E70 2D304002 */  daddu      $a2, $s2, $zero
    /* 1AD7F4 00381E74 9000A427 */  addiu      $a0, $sp, 0x90
    /* 1AD7F8 00381E78 3C220E0C */  jal        func_003888F0
    /* 1AD7FC 00381E7C 8C00A0E7 */   swc1      $f0, 0x8C($sp)
    /* 1AD800 00381E80 2200023C */  lui        $v0, %hi(D_00225980)
    /* 1AD804 00381E84 9C00A0C7 */  lwc1       $f0, 0x9C($sp)
    /* 1AD808 00381E88 80594224 */  addiu      $v0, $v0, %lo(D_00225980)
    /* 1AD80C 00381E8C 9400A2C7 */  lwc1       $f2, 0x94($sp)
    /* 1AD810 00381E90 200241C4 */  lwc1       $f1, 0x220($v0)
    ...
    /* 1AD824 00381EA4 A40146C4 */  lwc1       $f6, 0x1A4($v0)
    /* 1AD828 00381EA8 A00147C4 */  lwc1       $f7, 0x1A0($v0)
    ...
    /* 1AD844 00381EC4 A000B0DF */  ld         $s0, 0xA0($sp)
    /* 1AD848 00381EC8 82100146 */  mul.s      $f2, $f2, $f1
    /* 1AD84C 00381ECC B000B2DF */  ld         $s2, 0xB0($sp)
    /* 1AD850 00381ED0 C2180146 */  mul.s      $f3, $f3, $f1
    /* 1AD854 00381ED4 B800B3DF */  ld         $s3, 0xB8($sp)
    /* 1AD858 00381ED8 080020E6 */  swc1       $f0, 0x8($s1)
    /* 1AD85C 00381EDC 80100646 */  add.s      $f2, $f2, $f6
    /* 1AD860 00381EE0 C000BFDF */  ld         $ra, 0xC0($sp)
    ...
    /* 1AD87C 00381EFC 040021E6 */  swc1       $f1, 0x4($s1)
    /* 1AD880 00381F00 000024E6 */  swc1       $f4, 0x0($s1)
    /* 1AD884 00381F04 A800B1DF */  ld         $s1, 0xA8($sp)
    /* 1AD888 00381F08 0800E003 */  jr         $ra
