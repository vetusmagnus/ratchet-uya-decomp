...
glabel func_0039D6C8
    ...
    /* 1C904C 0039D6CC 0800B1FF */  sd         $s1, 0x8($sp)
    /* 1C9050 0039D6D0 0000B0FF */  sd         $s0, 0x0($sp)
    /* 1C9054 0039D6D4 1D00113C */  lui        $s1, %hi(D_1CCFD0)
    /* 1C9058 0039D6D8 15008010 */  beqz       $a0, .L0039D730
    /* 1C905C 0039D6DC 1000BFFF */   sd        $ra, 0x10($sp)
    /* 1C9060 0039D6E0 D0CF3026 */  addiu      $s0, $s1, %lo(D_1CCFD0)
...
.align 2
  .L0039D6E8:
    ...
    /* 1C9088 0039D708 04000286 */  lh         $v0, 0x4($s0)
    /* 1C908C 0039D70C 11004010 */  beqz       $v0, .L0039D754
    /* 1C9090 0039D710 D0CF2326 */   addiu     $v1, $s1, %lo(D_1CCFD0)
    /* 1C9094 0039D714 06210E0C */  jal        func_00388418
    /* 1C9098 0039D718 10270424 */   addiu     $a0, $zero, 0x2710
    /* 1C909C 0039D71C 04000286 */  lh         $v0, 0x4($s0)
    /* 1C90A0 0039D720 F1FF4014 */  bnez       $v0, .L0039D6E8
    /* 1C90A4 0039D724 D0CF2326 */   addiu     $v1, $s1, %lo(D_1CCFD0)
    /* 1C90A8 0039D728 0B000010 */  b          .L0039D758
    /* 1C90AC 0039D72C 0000B0DF */   ld        $s0, 0x0($sp)
.align 2
  .L0039D730:
    ...
    /* 1C90D0 0039D750 D0CF2326 */  addiu      $v1, $s1, %lo(D_1CCFD0)
.align 2
  .L0039D754:
    /* 1C90D4 0039D754 0000B0DF */  ld         $s0, 0x0($sp)
.align 2
  .L0039D758:
    /* 1C90D8 0039D758 04006284 */  lh         $v0, 0x4($v1)
    /* 1C90DC 0039D75C 0800B1DF */  ld         $s1, 0x8($sp)
    /* 1C90E0 0039D760 1000BFDF */  ld         $ra, 0x10($sp)
    /* 1C90E4 0039D764 0800E003 */  jr         $ra
