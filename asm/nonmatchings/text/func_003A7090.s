...
glabel func_003A7090
    ...
    /* 1D2A14 003A7094 0800B1FF */  sd         $s1, 0x8($sp)
    /* 1D2A18 003A7098 1000B2FF */  sd         $s2, 0x10($sp)
    /* 1D2A1C 003A709C 2D88A000 */  daddu      $s1, $a1, $zero
    /* 1D2A20 003A70A0 1800B3FF */  sd         $s3, 0x18($sp)
    /* 1D2A24 003A70A4 2D90C000 */  daddu      $s2, $a2, $zero
    /* 1D2A28 003A70A8 7800BBE7 */  swc1       $f27, 0x78($sp)
    /* 1D2A2C 003A70AC 2D988000 */  daddu      $s3, $a0, $zero
    ...
    /* 1D2A48 003A70C8 2800B5FF */  sd         $s5, 0x28($sp)
    /* 1D2A4C 003A70CC 06660046 */  mov.s      $f24, $f12
    /* 1D2A50 003A70D0 0000B0FF */  sd         $s0, 0x0($sp)
    /* 1D2A54 003A70D4 2000B4FF */  sd         $s4, 0x20($sp)
    /* 1D2A58 003A70D8 3000BFFF */  sd         $ra, 0x30($sp)
    ...
    /* 1D2A78 003A70F8 2DA84000 */  daddu      $s5, $v0, $zero
    /* 1D2A7C 003A70FC D6910E0C */  jal        func_003A4758
    /* 1D2A80 003A7100 2D200000 */   daddu     $a0, $zero, $zero
    /* 1D2A84 003A7104 1D00023C */  lui        $v0, %hi(D_001D5C78)
    /* 1D2A88 003A7108 785C428C */  lw         $v0, %lo(D_001D5C78)($v0)
    /* 1D2A8C 003A710C 88004010 */  beqz       $v0, .L003A7330
    /* 1D2A90 003A7110 2200023C */   lui       $v0, %hi(D_00225980)
    ...
    /* 1D2AA0 003A7120 80595424 */  addiu      $s4, $v0, %lo(D_00225980)
    /* 1D2AA4 003A7124 803F013C */  lui        $at, (0x3F800000 >> 16)
    /* 1D2AA8 003A7128 00E08144 */  mtc1       $at, $f28
    /* 1D2AAC 003A712C B0009DC6 */  lwc1       $f29, 0xB0($s4)
    /* 1D2AB0 003A7130 B00080E6 */  swc1       $f0, 0xB0($s4)
    ...
    /* 1D2B04 003A7184 01000324 */  addiu      $v1, $zero, 0x1
    /* 1D2B08 003A7188 04004314 */  bne        $v0, $v1, .L003A719C
    /* 1D2B0C 003A718C 408A828F */   lw        $v0, -0x75C0($gp) /* Failed to symbolize address 0x001D52F0 for %gp_rel. Make sure this address is within the recognized valid address space. */
...
.align 2
  .L003A719C:
    /* 1D2B1C 003A719C 00517026 */  addiu      $s0, $s3, 0x5100
    /* 1D2B20 003A71A0 80BF013C */  lui        $at, (0xBF800000 >> 16)
    /* 1D2B24 003A71A4 00A88144 */  mtc1       $at, $f21
    /* 1D2B28 003A71A8 008E1100 */  sll        $s1, $s1, 24
    /* 1D2B2C 003A71AC 80100200 */  sll        $v0, $v0, 2
    /* 1D2B30 003A71B0 25883202 */  or         $s1, $s1, $s2
    /* 1D2B34 003A71B4 21100202 */  addu       $v0, $s0, $v0
    /* 1D2B38 003A71B8 06BC0046 */  mov.s      $f16, $f23
    /* 1D2B3C 003A71BC 0000448C */  lw         $a0, 0x0($v0)
    /* 1D2B40 003A71C0 C6B30046 */  mov.s      $f15, $f22
    /* 1D2B44 003A71C4 06D30046 */  mov.s      $f12, $f26
    /* 1D2B48 003A71C8 46C30046 */  mov.s      $f13, $f24
    /* 1D2B4C 003A71CC 2D282002 */  daddu      $a1, $s1, $zero
    ...
    /* 1D2B60 003A71E0 1D00023C */  lui        $v0, (0x1D52F0 >> 16)
    /* 1D2B64 003A71E4 F052428C */  lw         $v0, (0x1D52F0 & 0xFFFF)($v0)
    /* 1D2B68 003A71E8 06BC0046 */  mov.s      $f16, $f23
    /* 1D2B6C 003A71EC C6B30046 */  mov.s      $f15, $f22
    /* 1D2B70 003A71F0 06CB0046 */  mov.s      $f12, $f25
    /* 1D2B74 003A71F4 80100200 */  sll        $v0, $v0, 2
    /* 1D2B78 003A71F8 46C30046 */  mov.s      $f13, $f24
    /* 1D2B7C 003A71FC 21800202 */  addu       $s0, $s0, $v0
    /* 1D2B80 003A7200 2D282002 */  daddu      $a1, $s1, $zero
    /* 1D2B84 003A7204 0000048E */  lw         $a0, 0x0($s0)
    /* 1D2B88 003A7208 86E30046 */  mov.s      $f14, $f28
    /* 1D2B8C 003A720C 10517026 */  addiu      $s0, $s3, 0x5110
    ...
    /* 1D2BC8 003A7248 1D00023C */  lui        $v0, (0x1D52F0 >> 16)
    /* 1D2BCC 003A724C F052428C */  lw         $v0, (0x1D52F0 & 0xFFFF)($v0)
    ...
    /* 1D2BDC 003A725C 2D282002 */  daddu      $a1, $s1, $zero
    /* 1D2BE0 003A7260 80100200 */  sll        $v0, $v0, 2
    ...
    /* 1D2BF4 003A7274 21100202 */  addu       $v0, $s0, $v0
    /* 1D2BF8 003A7278 0000448C */  lw         $a0, 0x0($v0)
    ...
    /* 1D2C10 003A7290 1D00023C */  lui        $v0, (0x1D52F0 >> 16)
    /* 1D2C14 003A7294 F052428C */  lw         $v0, (0x1D52F0 & 0xFFFF)($v0)
    /* 1D2C18 003A7298 46C30046 */  mov.s      $f13, $f24
    /* 1D2C1C 003A729C 06A30046 */  mov.s      $f12, $f20
    /* 1D2C20 003A72A0 2D282002 */  daddu      $a1, $s1, $zero
    /* 1D2C24 003A72A4 80100200 */  sll        $v0, $v0, 2
    /* 1D2C28 003A72A8 86E30046 */  mov.s      $f14, $f28
    /* 1D2C2C 003A72AC 21100202 */  addu       $v0, $s0, $v0
    /* 1D2C30 003A72B0 C6E30046 */  mov.s      $f15, $f28
    /* 1D2C34 003A72B4 0000448C */  lw         $a0, 0x0($v0)
    /* 1D2C38 003A72B8 72930E0C */  jal        func_003A4DC8
    /* 1D2C3C 003A72BC 06BC0046 */   mov.s     $f16, $f23
    /* 1D2C40 003A72C0 1D00023C */  lui        $v0, (0x1D52F0 >> 16)
    /* 1D2C44 003A72C4 F052428C */  lw         $v0, (0x1D52F0 & 0xFFFF)($v0)
    /* 1D2C48 003A72C8 06B30046 */  mov.s      $f12, $f22
    /* 1D2C4C 003A72CC 46DB0046 */  mov.s      $f13, $f27
    /* 1D2C50 003A72D0 2D282002 */  daddu      $a1, $s1, $zero
    /* 1D2C54 003A72D4 80100200 */  sll        $v0, $v0, 2
    /* 1D2C58 003A72D8 86AB0046 */  mov.s      $f14, $f21
    /* 1D2C5C 003A72DC 21100202 */  addu       $v0, $s0, $v0
    /* 1D2C60 003A72E0 C6AB0046 */  mov.s      $f15, $f21
    /* 1D2C64 003A72E4 0000448C */  lw         $a0, 0x0($v0)
    /* 1D2C68 003A72E8 72930E0C */  jal        func_003A4DC8
    /* 1D2C6C 003A72EC 06BC0046 */   mov.s     $f16, $f23
    /* 1D2C70 003A72F0 1D00023C */  lui        $v0, (0x1D52F0 >> 16)
    /* 1D2C74 003A72F4 F052428C */  lw         $v0, (0x1D52F0 & 0xFFFF)($v0)
    /* 1D2C78 003A72F8 06A30046 */  mov.s      $f12, $f20
    /* 1D2C7C 003A72FC 46DB0046 */  mov.s      $f13, $f27
    /* 1D2C80 003A7300 2D282002 */  daddu      $a1, $s1, $zero
    /* 1D2C84 003A7304 80100200 */  sll        $v0, $v0, 2
    /* 1D2C88 003A7308 86E30046 */  mov.s      $f14, $f28
    /* 1D2C8C 003A730C 21800202 */  addu       $s0, $s0, $v0
    /* 1D2C90 003A7310 C6AB0046 */  mov.s      $f15, $f21
    /* 1D2C94 003A7314 0000048E */  lw         $a0, 0x0($s0)
    ...
    /* 1D2CA4 003A7324 B0009DE6 */   swc1      $f29, 0xB0($s4)
    /* 1D2CA8 003A7328 D6910E0C */  jal        func_003A4758
    /* 1D2CAC 003A732C 2D20A002 */   daddu     $a0, $s5, $zero
.align 2
  .L003A7330:
    /* 1D2CB0 003A7330 0000B0DF */  ld         $s0, 0x0($sp)
    /* 1D2CB4 003A7334 0800B1DF */  ld         $s1, 0x8($sp)
    /* 1D2CB8 003A7338 1000B2DF */  ld         $s2, 0x10($sp)
    /* 1D2CBC 003A733C 1800B3DF */  ld         $s3, 0x18($sp)
    /* 1D2CC0 003A7340 2000B4DF */  ld         $s4, 0x20($sp)
    /* 1D2CC4 003A7344 2800B5DF */  ld         $s5, 0x28($sp)
    /* 1D2CC8 003A7348 3000BFDF */  ld         $ra, 0x30($sp)
    ...
    /* 1D2CF4 003A7374 0800E003 */  jr         $ra
