...
glabel func_003B5AB0
    ...
    /* 1E1434 003B5AB4 0000B0FF */  sd         $s0, 0x0($sp)
    /* 1E1438 003B5AB8 0800B1FF */  sd         $s1, 0x8($sp)
    /* 1E143C 003B5ABC 2D80C000 */  daddu      $s0, $a2, $zero
    /* 1E1440 003B5AC0 1000BFFF */  sd         $ra, 0x10($sp)
    /* 1E1444 003B5AC4 2D88A000 */  daddu      $s1, $a1, $zero
    ...
    /* 1E1454 003B5AD4 34008010 */  beqz       $a0, .L003B5BA8
    ...
    /* 1E1468 003B5AE8 FFFF0524 */  addiu      $a1, $zero, -0x1
    ...
    /* 1E148C 003B5B0C 00088244 */  mtc1       $v0, $f1
...
.align 2
  .L003B5B5C:
    /* 1E14DC 003B5B5C 00708044 */  mtc1       $zero, $f14
    ...
    /* 1E1508 003B5B88 000000E6 */   swc1      $f0, 0x0($s0)
    /* 1E150C 003B5B8C 05000010 */  b          .L003B5BA4
    /* 1E1510 003B5B90 000014E6 */   swc1      $f20, 0x0($s0)
.align 2
  .L003B5B94:
    /* 1E1514 003B5B94 34001646 */  c.lt.s     $f0, $f22
    /* 1E1518 003B5B98 00000000 */  nop
    /* 1E151C 003B5B9C 01000345 */  bc1tl      .L003B5BA4
    /* 1E1520 003B5BA0 000016E6 */   swc1      $f22, 0x0($s0)
.align 2
  .L003B5BA4:
    /* 1E1524 003B5BA4 000037E6 */  swc1       $f23, 0x0($s1)
.align 2
  .L003B5BA8:
    /* 1E1528 003B5BA8 0000B0DF */  ld         $s0, 0x0($sp)
    /* 1E152C 003B5BAC 0800B1DF */  ld         $s1, 0x8($sp)
    /* 1E1530 003B5BB0 1000BFDF */  ld         $ra, 0x10($sp)
    ...
    /* 1E1544 003B5BC4 0800E003 */  jr         $ra
