...
glabel func_003DE8F0
    ...
    /* 20A274 003DE8F4 1A00023C */  lui        $v0, %hi(D_1A4BE0)
    /* 20A278 003DE8F8 2000B0FF */  sd         $s0, 0x20($sp)
    /* 20A27C 003DE8FC 2D204000 */  daddu      $a0, $v0, $zero
    /* 20A280 003DE900 2800B1FF */  sd         $s1, 0x28($sp)
    /* 20A284 003DE904 E04B4224 */  addiu      $v0, $v0, %lo(D_1A4BE0)
    /* 20A288 003DE908 3000B2FF */  sd         $s2, 0x30($sp)
    /* 20A28C 003DE90C 3800B3FF */  sd         $s3, 0x38($sp)
    /* 20A290 003DE910 4000B4FF */  sd         $s4, 0x40($sp)
    /* 20A294 003DE914 4800B5FF */  sd         $s5, 0x48($sp)
    /* 20A298 003DE918 5000BFFF */  sd         $ra, 0x50($sp)
    ...
    /* 20A2B0 003DE930 E4254390 */  lbu        $v1, 0x25E4($v0)
    /* 20A2B4 003DE934 01006338 */  xori       $v1, $v1, 0x1
    /* 20A2B8 003DE938 03006014 */  bnez       $v1, .L003DE948
    /* 20A2BC 003DE93C 5028538C */   lw        $s3, 0x2850($v0)
    /* 20A2C0 003DE940 03000010 */  b          .L003DE950
    /* 20A2C4 003DE944 04000624 */   addiu     $a2, $zero, 0x4
.align 2
  .L003DE948:
    /* 20A2C8 003DE948 1400023C */  lui        $v0, (0x142668 >> 16)
    /* 20A2CC 003DE94C 6826468C */  lw         $a2, (0x142668 & 0xFFFF)($v0)
.align 2
  .L003DE950:
    /* 20A2D0 003DE950 E04B8424 */  addiu      $a0, $a0, %lo(D_1A4BE0)
    /* 20A2D4 003DE954 C425838C */  lw         $v1, 0x25C4($a0)
    /* 20A2D8 003DE958 31000224 */  addiu      $v0, $zero, 0x31
    /* 20A2DC 003DE95C 1A006214 */  bne        $v1, $v0, .L003DE9C8
    /* 20A2E0 003DE960 2DA0C000 */   daddu     $s4, $a2, $zero
    /* 20A2E4 003DE964 E019848C */  lw         $a0, 0x19E0($a0)
    /* 20A2E8 003DE968 17008010 */  beqz       $a0, .L003DE9C8
    /* 20A2EC 003DE96C 171A0224 */   addiu     $v0, $zero, 0x1A17
    /* 20A2F0 003DE970 AA008384 */  lh         $v1, 0xAA($a0)
    /* 20A2F4 003DE974 03006210 */  beq        $v1, $v0, .L003DE984
    /* 20A2F8 003DE978 7E100224 */   addiu     $v0, $zero, 0x107E
    /* 20A2FC 003DE97C 13006214 */  bne        $v1, $v0, .L003DE9CC
    /* 20A300 003DE980 1400023C */   lui       $v0, %hi(D_142CA0)
.align 2
  .L003DE984:
    /* 20A304 003DE984 2EF80D0C */  jal        func_0037E0B8
    /* 20A308 003DE988 00000000 */   nop
    /* 20A30C 003DE98C 2D184000 */  daddu      $v1, $v0, $zero
    /* 20A310 003DE990 0E006010 */  beqz       $v1, .L003DE9CC
    /* 20A314 003DE994 1400023C */   lui       $v0, %hi(D_142CA0)
    /* 20A318 003DE998 04006284 */  lh         $v0, 0x4($v1)
    /* 20A31C 003DE99C 64001424 */  addiu      $s4, $zero, 0x64
    /* 20A320 003DE9A0 C842013C */  lui        $at, (0x42C80000 >> 16)
    /* 20A324 003DE9A4 00088144 */  mtc1       $at, $f1
    /* 20A328 003DE9A8 000060C4 */  lwc1       $f0, 0x0($v1)
    /* 20A32C 003DE9AC 00108244 */  mtc1       $v0, $f2
    ...
    /* 20A344 003DE9C4 00081344 */  mfc1       $s3, $f1
.align 2
  .L003DE9C8:
    /* 20A348 003DE9C8 1400023C */  lui        $v0, %hi(D_142CA0)
.align 2
  .L003DE9CC:
    /* 20A34C 003DE9CC 00C09344 */  mtc1       $s3, $f24
    /* 20A350 003DE9D0 00000000 */  nop
    /* 20A354 003DE9D4 20C68046 */  cvt.s.w    $f24, $f24
    /* 20A358 003DE9D8 2DA84000 */  daddu      $s5, $v0, $zero
    /* 20A35C 003DE9DC 00B89444 */  mtc1       $s4, $f23
    /* 20A360 003DE9E0 00000000 */  nop
    /* 20A364 003DE9E4 E0BD8046 */  cvt.s.w    $f23, $f23
    /* 20A368 003DE9E8 A02C4224 */  addiu      $v0, $v0, %lo(D_142CA0)
    /* 20A36C 003DE9EC 20004390 */  lbu        $v1, 0x20($v0)
    /* 20A370 003DE9F0 31006054 */  bnel       $v1, $zero, .L003DEAB8
    /* 20A374 003DE9F4 0400A437 */   ori       $a0, $sp, 0x4
    ...
    /* 20A390 003DEA10 2D20A003 */  daddu      $a0, $sp, $zero
    ...
    /* 20A3C0 003DEA40 0900043C */  lui        $a0, (0x9000A >> 16)
    /* 20A3C4 003DEA44 0A008434 */  ori        $a0, $a0, (0x9000A & 0xFFFF)
    ...
    /* 20A3E0 003DEA60 0900043C */  lui        $a0, (0x9000A >> 16)
    /* 20A3E4 003DEA64 0A008434 */  ori        $a0, $a0, (0x9000A & 0xFFFF)
    /* 20A3E8 003DEA68 94870F0C */  jal        func_003E1E50
    /* 20A3EC 003DEA6C 46B30046 */   mov.s     $f13, $f22
    /* 20A3F0 003DEA70 0000ACC7 */  lwc1       $f12, 0x0($sp)
    /* 20A3F4 003DEA74 0900043C */  lui        $a0, (0x9000B >> 16)
    /* 20A3F8 003DEA78 46AB0046 */  mov.s      $f13, $f21
    /* 20A3FC 003DEA7C 228B0F0C */  jal        func_003E2C88
    /* 20A400 003DEA80 0B008434 */   ori       $a0, $a0, (0x9000B & 0xFFFF)
    /* 20A404 003DEA84 0900043C */  lui        $a0, (0x9000B >> 16)
    ...
    /* 20A414 003DEA94 0B008434 */  ori        $a0, $a0, (0x9000B & 0xFFFF)
    /* 20A418 003DEA98 94870F0C */  jal        func_003E1E50
    /* 20A41C 003DEA9C 46B30046 */   mov.s     $f13, $f22
    /* 20A420 003DEAA0 0900043C */  lui        $a0, (0x90008 >> 16)
    /* 20A424 003DEAA4 2D280000 */  daddu      $a1, $zero, $zero
    /* 20A428 003DEAA8 2C890F0C */  jal        func_003E24B0
    /* 20A42C 003DEAAC 08008434 */   ori       $a0, $a0, (0x90008 & 0xFFFF)
    /* 20A430 003DEAB0 38000010 */  b          .L003DEB94
    /* 20A434 003DEAB4 0A001024 */   addiu     $s0, $zero, 0xA
.align 2
  .L003DEAB8:
    ...
    /* 20A47C 003DEAFC 0900043C */  lui        $a0, (0x9000A >> 16)
    /* 20A480 003DEB00 0A008434 */  ori        $a0, $a0, (0x9000A & 0xFFFF)
    ...
    /* 20A4CC 003DEB4C 0900043C */  lui        $a0, (0x9000B >> 16)
    /* 20A4D0 003DEB50 46B30046 */  mov.s      $f13, $f22
    /* 20A4D4 003DEB54 94870F0C */  jal        func_003E1E50
    /* 20A4D8 003DEB58 0B008434 */   ori       $a0, $a0, (0x9000B & 0xFFFF)
    /* 20A4DC 003DEB5C 0900043C */  lui        $a0, (0x90008 >> 16)
    /* 20A4E0 003DEB60 01000524 */  addiu      $a1, $zero, 0x1
    /* 20A4E4 003DEB64 2C890F0C */  jal        func_003E24B0
    /* 20A4E8 003DEB68 08008434 */   ori       $a0, $a0, (0x90008 & 0xFFFF)
    /* 20A4EC 003DEB6C 0900043C */  lui        $a0, (0x90008 >> 16)
    ...
    /* 20A50C 003DEB8C 08008434 */   ori       $a0, $a0, (0x90008 & 0xFFFF)
    /* 20A510 003DEB90 0A001024 */  addiu      $s0, $zero, 0xA
.align 2
  .L003DEB94:
    ...
    /* 20A520 003DEBA0 1A007002 */  div        $zero, $s3, $s0
    /* 20A524 003DEBA4 12880000 */  mflo       $s1
    /* 20A528 003DEBA8 10200000 */  mfhi       $a0
    /* 20A52C 003DEBAC 387A0F0C */  jal        func_003DE8E0
    /* 20A530 003DEBB0 00000000 */   nop
    /* 20A534 003DEBB4 1A003002 */  div        $zero, $s1, $s0
    /* 20A538 003DEBB8 10200000 */  mfhi       $a0
    /* 20A53C 003DEBBC 387A0F0C */  jal        func_003DE8E0
    /* 20A540 003DEBC0 2D884000 */   daddu     $s1, $v0, $zero
    /* 20A544 003DEBC4 64000324 */  addiu      $v1, $zero, 0x64
    /* 20A548 003DEBC8 2D904000 */  daddu      $s2, $v0, $zero
    /* 20A54C 003DEBCC 1A006302 */  div        $zero, $s3, $v1
    /* 20A550 003DEBD0 12180000 */  mflo       $v1
    /* 20A554 003DEBD4 1A007000 */  div        $zero, $v1, $s0
    /* 20A558 003DEBD8 10200000 */  mfhi       $a0
    /* 20A55C 003DEBDC 387A0F0C */  jal        func_003DE8E0
    /* 20A560 003DEBE0 2B980400 */   sltu      $s3, $zero, $a0
    /* 20A564 003DEBE4 0900043C */  lui        $a0, (0x90003 >> 16)
    /* 20A568 003DEBE8 2D804000 */  daddu      $s0, $v0, $zero
    /* 20A56C 003DEBEC 2D282002 */  daddu      $a1, $s1, $zero
    /* 20A570 003DEBF0 388A0F0C */  jal        func_003E28E0
    /* 20A574 003DEBF4 03008434 */   ori       $a0, $a0, (0x90003 & 0xFFFF)
    /* 20A578 003DEBF8 0900043C */  lui        $a0, (0x90004 >> 16)
    /* 20A57C 003DEBFC 2D284002 */  daddu      $a1, $s2, $zero
    /* 20A580 003DEC00 388A0F0C */  jal        func_003E28E0
    /* 20A584 003DEC04 04008434 */   ori       $a0, $a0, (0x90004 & 0xFFFF)
    /* 20A588 003DEC08 0900043C */  lui        $a0, (0x90005 >> 16)
    /* 20A58C 003DEC0C 2D280002 */  daddu      $a1, $s0, $zero
    /* 20A590 003DEC10 388A0F0C */  jal        func_003E28E0
    /* 20A594 003DEC14 05008434 */   ori       $a0, $a0, (0x90005 & 0xFFFF)
    /* 20A598 003DEC18 0900043C */  lui        $a0, (0x90005 >> 16)
    /* 20A59C 003DEC1C 01000524 */  addiu      $a1, $zero, 0x1
    /* 20A5A0 003DEC20 05008434 */  ori        $a0, $a0, (0x90005 & 0xFFFF)
    /* 20A5A4 003DEC24 B4880F0C */  jal        func_003E22D0
    /* 20A5A8 003DEC28 2D306002 */   daddu     $a2, $s3, $zero
    /* 20A5AC 003DEC2C 04006012 */  beqz       $s3, .L003DEC40
    /* 20A5B0 003DEC30 1E00053C */   lui       $a1, %hi(D_001D95A0)
...
.align 2
  .L003DEC40:
    /* 20A5C0 003DEC40 2D308002 */  daddu      $a2, $s4, $zero
    /* 20A5C4 003DEC44 1E00043C */  lui        $a0, %hi(D_001DA868)
    /* 20A5C8 003DEC48 68A88424 */  addiu      $a0, $a0, %lo(D_001DA868)
    /* 20A5CC 003DEC4C BA6C040C */  jal        func_11B2E8
    /* 20A5D0 003DEC50 A095A524 */   addiu     $a1, $a1, %lo(D_001D95A0)
    /* 20A5D4 003DEC54 00008044 */  mtc1       $zero, $f0
    /* 20A5D8 003DEC58 0C00A627 */  addiu      $a2, $sp, 0xC
    /* 20A5DC 003DEC5C 0900043C */  lui        $a0, (0x90006 >> 16)
    /* 20A5E0 003DEC60 0800A537 */  ori        $a1, $sp, 0x8
    /* 20A5E4 003DEC64 1000A0E7 */  swc1       $f0, 0x10($sp)
    /* 20A5E8 003DEC68 06008434 */  ori        $a0, $a0, (0x90006 & 0xFFFF)
    /* 20A5EC 003DEC6C 0800A0E7 */  swc1       $f0, 0x8($sp)
    /* 20A5F0 003DEC70 1000A727 */  addiu      $a3, $sp, 0x10
    /* 20A5F4 003DEC74 86890F0C */  jal        func_003E2618
    /* 20A5F8 003DEC78 2D40C000 */   daddu     $t0, $a2, $zero
    /* 20A5FC 003DEC7C 0800A1C7 */  lwc1       $f1, 0x8($sp)
    /* 20A600 003DEC80 A02CA226 */  addiu      $v0, $s5, %lo(D_142CA0)
    /* 20A604 003DEC84 1000A0C7 */  lwc1       $f0, 0x10($sp)
    /* 20A608 003DEC88 20004390 */  lbu        $v1, 0x20($v0)
    /* 20A60C 003DEC8C 01000146 */  sub.s      $f0, $f0, $f1
    /* 20A610 003DEC90 003F013C */  lui        $at, (0x3F000000 >> 16)
    /* 20A614 003DEC94 00608144 */  mtc1       $at, $f12
    /* 20A618 003DEC98 04006010 */  beqz       $v1, .L003DECAC
...
.align 2
  .L003DECAC:
    ...
    /* 20A63C 003DECBC 0D006012 */  beqz       $s3, .L003DECF4
    /* 20A640 003DECC0 81650046 */   sub.s     $f22, $f12, $f0
    /* 20A644 003DECC4 0900043C */  lui        $a0, (0x90005 >> 16)
    ...
    /* 20A65C 003DECDC 05008434 */   ori       $a0, $a0, (0x90005 & 0xFFFF)
...
.align 2
  .L003DECF4:
    ...
    /* 20A690 003DED10 0900043C */  lui        $a0, (0x90004 >> 16)
    /* 20A694 003DED14 04008434 */  ori        $a0, $a0, (0x90004 & 0xFFFF)
    ...
    /* 20A6A4 003DED24 0900043C */  lui        $a0, (0x90003 >> 16)
    /* 20A6A8 003DED28 46A30046 */  mov.s      $f13, $f20
    /* 20A6AC 003DED2C 03008434 */  ori        $a0, $a0, (0x90003 & 0xFFFF)
    ...
    /* 20A6BC 003DED3C 0900043C */  lui        $a0, (0x90006 >> 16)
    ...
    /* 20A6D0 003DED50 06008434 */   ori       $a0, $a0, (0x90006 & 0xFFFF)
    ...
    /* 20A6F4 003DED74 E8CC81C7 */   lwc1      $f1, %gp_rel(D_001D9598)($gp)
    ...
    /* 20A71C 003DED9C E8CC80E7 */   swc1      $f0, %gp_rel(D_001D9598)($gp)
    /* 20A720 003DEDA0 01000246 */  sub.s      $f0, $f0, $f2
    /* 20A724 003DEDA4 E8CC80E7 */  swc1       $f0, %gp_rel(D_001D9598)($gp)
.align 2
  .L003DEDA8:
    /* 20A728 003DEDA8 E0CC828F */  lw         $v0, %gp_rel(D_001D9590)($gp)
    /* 20A72C 003DEDAC 01004224 */  addiu      $v0, $v0, 0x1
    /* 20A730 003DEDB0 14000010 */  b          .L003DEE04
    /* 20A734 003DEDB4 E0CC82AF */   sw        $v0, %gp_rel(D_001D9590)($gp)
.align 2
  .L003DEDB8:
    ...
    /* 20A750 003DEDD0 E8CC80C7 */   lwc1      $f0, %gp_rel(D_001D9598)($gp)
    ...
    /* 20A764 003DEDE4 E8CC80E7 */  swc1       $f0, %gp_rel(D_001D9598)($gp)
    /* 20A768 003DEDE8 E8CC80C7 */  lwc1       $f0, %gp_rel(D_001D9598)($gp)
.align 2
  .L003DEDEC:
    ...
    /* 20A780 003DEE00 E8CC80E7 */  swc1       $f0, %gp_rel(D_001D9598)($gp)
.align 2
  .L003DEE04:
    /* 20A784 003DEE04 E8CC8CC7 */  lwc1       $f12, %gp_rel(D_001D9598)($gp)
...
.align 2
  .L003DEE34:
    ...
    /* 20A7D0 003DEE50 6680043C */  lui        $a0, (0x8066CCFF >> 16)
    /* 20A7D4 003DEE54 003F013C */  lui        $at, (0x3F000000 >> 16)
    /* 20A7D8 003DEE58 00088144 */  mtc1       $at, $f1
    /* 20A7DC 003DEE5C 2060053C */  lui        $a1, (0x60202080 >> 16)
    /* 20A7E0 003DEE60 01630046 */  sub.s      $f12, $f12, $f0
    /* 20A7E4 003DEE64 FFCC8434 */  ori        $a0, $a0, (0x8066CCFF & 0xFFFF)
    /* 20A7E8 003DEE68 8020A534 */  ori        $a1, $a1, (0x60202080 & 0xFFFF)
    /* 20A7EC 003DEE6C 28250E0C */  jal        func_003894A0
    /* 20A7F0 003DEE70 02630146 */   mul.s     $f12, $f12, $f1
    /* 20A7F4 003DEE74 2D804000 */  daddu      $s0, $v0, $zero
    /* 20A7F8 003DEE78 0900043C */  lui        $a0, (0x90003 >> 16)
    /* 20A7FC 003DEE7C 2D280002 */  daddu      $a1, $s0, $zero
    /* 20A800 003DEE80 028A0F0C */  jal        func_003E2808
    /* 20A804 003DEE84 03008434 */   ori       $a0, $a0, (0x90003 & 0xFFFF)
    /* 20A808 003DEE88 0900043C */  lui        $a0, (0x90004 >> 16)
    /* 20A80C 003DEE8C 2D280002 */  daddu      $a1, $s0, $zero
    /* 20A810 003DEE90 028A0F0C */  jal        func_003E2808
    /* 20A814 003DEE94 04008434 */   ori       $a0, $a0, (0x90004 & 0xFFFF)
    /* 20A818 003DEE98 0900043C */  lui        $a0, (0x90005 >> 16)
    /* 20A81C 003DEE9C 2D280002 */  daddu      $a1, $s0, $zero
    /* 20A820 003DEEA0 028A0F0C */  jal        func_003E2808
    /* 20A824 003DEEA4 05008434 */   ori       $a0, $a0, (0x90005 & 0xFFFF)
    /* 20A828 003DEEA8 0900043C */  lui        $a0, (0x90006 >> 16)
    /* 20A82C 003DEEAC 2D280002 */  daddu      $a1, $s0, $zero
    /* 20A830 003DEEB0 028A0F0C */  jal        func_003E2808
    /* 20A834 003DEEB4 06008434 */   ori       $a0, $a0, (0x90006 & 0xFFFF)
    /* 20A838 003DEEB8 2000B0DF */  ld         $s0, 0x20($sp)
    /* 20A83C 003DEEBC 2800B1DF */  ld         $s1, 0x28($sp)
    /* 20A840 003DEEC0 3000B2DF */  ld         $s2, 0x30($sp)
    /* 20A844 003DEEC4 3800B3DF */  ld         $s3, 0x38($sp)
    /* 20A848 003DEEC8 4000B4DF */  ld         $s4, 0x40($sp)
    /* 20A84C 003DEECC 4800B5DF */  ld         $s5, 0x48($sp)
    /* 20A850 003DEED0 5000BFDF */  ld         $ra, 0x50($sp)
    ...
    /* 20A868 003DEEE8 0800E003 */  jr         $ra
