...
glabel func_003AE368
    /* 1D9CE8 003AE368 D8BF838F */  lw         $v1, %gp_rel(D_001D8888)($gp)
    /* 1D9CEC 003AE36C F0FFBD27 */  addiu      $sp, $sp, -0x10
    /* 1D9CF0 003AE370 0900622C */  sltiu      $v0, $v1, 0x9
    /* 1D9CF4 003AE374 28004010 */  beqz       $v0, .L003AE418
    /* 1D9CF8 003AE378 0000BFFF */   sd        $ra, 0x0($sp)
    /* 1D9CFC 003AE37C 3200023C */  lui        $v0, %hi(jtbl_00318690)
    /* 1D9D00 003AE380 80180300 */  sll        $v1, $v1, 2
    /* 1D9D04 003AE384 90864224 */  addiu      $v0, $v0, %lo(jtbl_00318690)
    /* 1D9D08 003AE388 21186200 */  addu       $v1, $v1, $v0
    /* 1D9D0C 003AE38C 0000648C */  lw         $a0, 0x0($v1)
    /* 1D9D10 003AE390 08008000 */  jr         $a0
