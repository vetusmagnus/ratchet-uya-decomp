...
glabel func_003A5458
    /* 1D0DD8 003A5458 180180AC */  sw         $zero, 0x118($a0)
    ...
    /* 1D0DFC 003A547C 1E00023C */  lui        $v0, %hi(D_001D8160)
    /* 1D0E00 003A5480 60814224 */  addiu      $v0, $v0, %lo(D_001D8160)
    /* 1D0E04 003A5484 0000BFFF */  sd         $ra, 0x0($sp)
    /* 1D0E08 003A5488 EC940E0C */  jal        func_003A53B0
    /* 1D0E0C 003A548C 040082AC */   sw        $v0, 0x4($a0)
    /* 1D0E10 003A5490 0000BFDF */  ld         $ra, 0x0($sp)
    /* 1D0E14 003A5494 0800E003 */  jr         $ra
