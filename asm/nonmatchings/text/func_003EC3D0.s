...
glabel func_003EC3D0
    ...
    /* 217D64 003EC3E4 00A88044 */  mtc1       $0, $f21
    /* 217D68 003EC3E8 2000B0FF */  sd         $16, 0x20($sp)
    /* 217D6C 003EC3EC 2800B1FF */  sd         $17, 0x28($sp)
    /* 217D70 003EC3F0 2D808000 */  daddu      $16, $4, $0
    /* 217D74 003EC3F4 3000B2FF */  sd         $18, 0x30($sp)
    /* 217D78 003EC3F8 2D88C000 */  daddu      $17, $6, $0
    /* 217D7C 003EC3FC 5800B7E7 */  swc1       $f23, 0x58($sp)
    /* 217D80 003EC400 2D90A000 */  daddu      $18, $5, $0
    /* 217D84 003EC404 4000B4E7 */  swc1       $f20, 0x40($sp)
    /* 217D88 003EC408 C6B50046 */  mov.s      $f23, $f22
    /* 217D8C 003EC40C 3800BFFF */  sd         $31, 0x38($sp)
    /* 217D90 003EC410 2100E010 */  beqz       $7, .L003EC498
    /* 217D94 003EC414 06AD0046 */   mov.s     $f20, $f21
    /* 217D98 003EC418 1000A0AF */  sw         $0, 0x10($sp)
    /* 217D9C 003EC41C 1400A0AF */  sw         $0, 0x14($sp)
    /* 217DA0 003EC420 1000A527 */  addiu      $5, $sp, 0x10
    /* 217DA4 003EC424 76A10F0C */  jal        func_003E85D8
    /* 217DA8 003EC428 1400A627 */   addiu     $6, $sp, 0x14
    /* 217DAC 003EC42C 1000A38F */  lw         $3, 0x10($sp)
    /* 217DB0 003EC430 03000224 */  addiu      $2, $0, 0x3
    /* 217DB4 003EC434 08006210 */  beq        $3, $2, .L003EC458
    /* 217DB8 003EC438 01000224 */   addiu     $2, $0, 0x1
    /* 217DBC 003EC43C 803F013C */  lui        $at, (0x3F800000 >> 16)
    /* 217DC0 003EC440 00A08144 */  mtc1       $at, $f20
    /* 217DC4 003EC444 05006210 */  beq        $3, $2, .L003EC45C
    /* 217DC8 003EC448 1400A38F */   lw        $3, 0x14($sp)
    /* 217DCC 003EC44C 80BF013C */  lui        $at, (0xBF800000 >> 16)
    /* 217DD0 003EC450 00A08144 */  mtc1       $at, $f20
    /* 217DD4 003EC454 C6B50046 */  mov.s      $f23, $f22
.align 2
  .L003EC458:
    /* 217DD8 003EC458 1400A38F */  lw         $3, 0x14($sp)
.align 2
  .L003EC45C:
    /* 217DDC 003EC45C 03000224 */  addiu      $2, $0, 0x3
    /* 217DE0 003EC460 0D006210 */  beq        $3, $2, .L003EC498
    /* 217DE4 003EC464 02000224 */   addiu     $2, $0, 0x2
    /* 217DE8 003EC468 07006214 */  bne        $3, $2, .L003EC488
    ...
    /* 217E04 003EC484 000045C6 */   lwc1      $f5, 0x0($18)
.align 2
  .L003EC488:
...
.align 2
  .L003EC498:
    /* 217E18 003EC498 000045C6 */  lwc1       $f5, 0x0($18)
.align 2
  .L003EC49C:
    /* 217E1C 003EC49C 2D200002 */  daddu      $4, $16, $0
    /* 217E20 003EC4A0 080041C6 */  lwc1       $f1, 0x8($18)
    /* 217E24 003EC4A4 40000524 */  addiu      $5, $0, 0x40
    /* 217E28 003EC4A8 180002C6 */  lwc1       $f2, 0x18($16)
    /* 217E2C 003EC4AC 41080546 */  sub.s      $f1, $f1, $f5
    /* 217E30 003EC4B0 100006C6 */  lwc1       $f6, 0x10($16)
    /* 217E34 003EC4B4 C2A00246 */  mul.s      $f3, $f20, $f2
    /* 217E38 003EC4B8 040044C6 */  lwc1       $f4, 0x4($18)
    /* 217E3C 003EC4BC 00000000 */  nop
    /* 217E40 003EC4C0 00000000 */  nop
    /* 217E44 003EC4C4 83101746 */  div.s      $f2, $f2, $f23
    /* 217E48 003EC4C8 0C0040C6 */  lwc1       $f0, 0xC($18)
    /* 217E4C 003EC4CC 42080646 */  mul.s      $f1, $f1, $f6
    /* 217E50 003EC4D0 140007C6 */  lwc1       $f7, 0x14($16)
    ...
    /* 217E78 003EC4F8 000022E6 */  swc1       $f2, 0x0($17)
    /* 217E7C 003EC4FC 1C0000C6 */  lwc1       $f0, 0x1C($16)
    ...
    /* 217E94 003EC514 040020E6 */  swc1       $f0, 0x4($17)
    /* 217E98 003EC518 180001C6 */  lwc1       $f1, 0x18($16)
    /* 217E9C 003EC51C 80100146 */  add.s      $f2, $f2, $f1
    /* 217EA0 003EC520 080022E6 */  swc1       $f2, 0x8($17)
    /* 217EA4 003EC524 1C0001C6 */  lwc1       $f1, 0x1C($16)
    /* 217EA8 003EC528 00000146 */  add.s      $f0, $f0, $f1
    /* 217EAC 003EC52C 64A10F0C */  jal        func_003E8590
    /* 217EB0 003EC530 0C0020E6 */   swc1      $f0, 0xC($17)
    /* 217EB4 003EC534 34004010 */  beqz       $2, .L003EC608
    /* 217EB8 003EC538 2D20A003 */   daddu     $4, $sp, $0
    /* 217EBC 003EC53C 240015C6 */  lwc1       $f21, 0x24($16)
    /* 217EC0 003EC540 200014C6 */  lwc1       $f20, 0x20($16)
    /* 217EC4 003EC544 2D280000 */  daddu      $5, $0, $0
    /* 217EC8 003EC548 9968040C */  jal        func_0011A264
    /* 217ECC 003EC54C 10000624 */   addiu     $6, $0, 0x10
    /* 217ED0 003EC550 0700226A */  ldl        $2, 0x7($17)
    /* 217ED4 003EC554 0000226E */  ldr        $2, 0x0($17)
    /* 217ED8 003EC558 0F00236A */  ldl        $3, 0xF($17)
    /* 217EDC 003EC55C 0800236E */  ldr        $3, 0x8($17)
    /* 217EE0 003EC560 0700A2B3 */  sdl        $2, 0x7($sp)
    /* 217EE4 003EC564 0000A2B7 */  sdr        $2, 0x0($sp)
    /* 217EE8 003EC568 0F00A3B3 */  sdl        $3, 0xF($sp)
    /* 217EEC 003EC56C 0800A3B7 */  sdr        $3, 0x8($sp)
    ...
    /* 217F08 003EC588 000023C6 */  lwc1       $f3, 0x0($17)
...
.align 2
  .L003EC5B4:
    /* 217F34 003EC5B4 080020C6 */  lwc1       $f0, 0x8($17)
    /* 217F38 003EC5B8 000026E6 */  swc1       $f6, 0x0($17)
...
.align 2
  .L003EC5D0:
    /* 217F50 003EC5D0 0C0020C6 */  lwc1       $f0, 0xC($17)
    /* 217F54 003EC5D4 080023E6 */  swc1       $f3, 0x8($17)
...
.align 2
  .L003EC5EC:
    /* 217F6C 003EC5EC 040020C6 */  lwc1       $f0, 0x4($17)
    /* 217F70 003EC5F0 34080046 */  c.lt.s     $f1, $f0
    /* 217F74 003EC5F4 00000000 */  nop
    /* 217F78 003EC5F8 02000045 */  bc1f       .L003EC604
    /* 217F7C 003EC5FC 0C0022E6 */   swc1      $f2, 0xC($17)
    /* 217F80 003EC600 06080046 */  mov.s      $f0, $f1
.align 2
  .L003EC604:
    /* 217F84 003EC604 040020E6 */  swc1       $f0, 0x4($17)
.align 2
  .L003EC608:
    /* 217F88 003EC608 2000B0DF */  ld         $16, 0x20($sp)
    /* 217F8C 003EC60C 2800B1DF */  ld         $17, 0x28($sp)
    /* 217F90 003EC610 3000B2DF */  ld         $18, 0x30($sp)
    /* 217F94 003EC614 3800BFDF */  ld         $31, 0x38($sp)
    ...
    /* 217FA8 003EC628 0800E003 */  jr         $31
