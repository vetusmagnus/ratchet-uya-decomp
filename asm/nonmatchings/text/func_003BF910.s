...
glabel func_003BF910
    ...
    /* 1EB294 003BF914 1000B0FF */  sd         $s0, 0x10($sp)
    /* 1EB298 003BF918 1800BFFF */  sd         $ra, 0x18($sp)
    /* 1EB29C 003BF91C 2D80A000 */  daddu      $s0, $a1, $zero
    /* 1EB2A0 003BF920 000086C4 */  lwc1       $f6, 0x0($a0)
    /* 1EB2A4 003BF924 040085C4 */  lwc1       $f5, 0x4($a0)
    /* 1EB2A8 003BF928 45300046 */  abs.s      $f1, $f6
    /* 1EB2AC 003BF92C 05280046 */  abs.s      $f0, $f5
    /* 1EB2B0 003BF930 080087C4 */  lwc1       $f7, 0x8($a0)
...
.align 2
  .L003BF958:
    ...
    /* 1EB2E4 003BF964 FF000624 */  addiu      $a2, $zero, 0xFF
    /* 1EB2E8 003BF968 7C42013C */  lui        $at, (0x427C0000 >> 16)
    /* 1EB2EC 003BF96C 00208144 */  mtc1       $at, $f4
    /* 1EB2F0 003BF970 01000724 */  addiu      $a3, $zero, 0x1
    ...
    /* 1EB30C 003BF98C 2D20A003 */  daddu      $a0, $sp, $zero
    ...
    /* 1EB328 003BF9A8 00200244 */  mfc1       $v0, $f4
    /* 1EB32C 003BF9AC 00014328 */  slti       $v1, $v0, 0x100
    /* 1EB330 003BF9B0 0A10C300 */  movz       $v0, $a2, $v1
    /* 1EB334 003BF9B4 2A280200 */  slt        $a1, $zero, $v0
    /* 1EB338 003BF9B8 0A10E500 */  movz       $v0, $a3, $a1
    /* 1EB33C 003BF9BC 00008244 */  mtc1       $v0, $f0
    ...
    /* 1EB384 003BFA04 000002AE */  sw         $v0, 0x0($s0)
    /* 1EB388 003BFA08 1000B0DF */  ld         $s0, 0x10($sp)
    /* 1EB38C 003BFA0C 1800BFDF */  ld         $ra, 0x18($sp)
    /* 1EB390 003BFA10 0800E003 */  jr         $ra
