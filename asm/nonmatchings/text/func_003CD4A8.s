...
.align 2
  alabel D_003CD4BC
    /* 1F8E3C 003CD4BC F7FF2010 */  beqz       $at, .L003CD49C
    /* 1F8E40 003CD4C0 00000000 */   nop
    /* 1F8E44 003CD4C4 E7FF4014 */  bnez       $v0, .L003CD464
    /* 1F8E48 003CD4C8 00000000 */   nop
.align 2
  .L003CD4CC:
    /* 1F8E4C 003CD4CC 3D00073C */  lui        $a3, %hi(D_003CD4BC)
    /* 1F8E50 003CD4D0 BCD4E724 */  addiu      $a3, $a3, %lo(D_003CD4BC)
    /* 1F8E54 003CD4D4 2DF8C000 */  daddu      $ra, $a2, $zero
...
.align 2
  alabel D_003CD4EC
    ...
    /* 1F8E7C 003CD4FC 1B004014 */  bnez       $v0, .L003CD56C
    /* 1F8E80 003CD500 00000000 */   nop
.align 2
  .L003CD504:
    /* 1F8E84 003CD504 3D00073C */  lui        $a3, %hi(D_003CD524)
    /* 1F8E88 003CD508 24D5E724 */  addiu      $a3, $a3, %lo(D_003CD524)
    /* 1F8E8C 003CD50C 2DF8C000 */  daddu      $ra, $a2, $zero
