...
glabel func_0038C3C0
    ...
    /* 1B7D44 0038C3C4 0000B0FF */  sd         $16, 0x0($sp)
    /* 1B7D48 0038C3C8 1800B5E7 */  swc1       $f21, 0x18($sp)
    /* 1B7D4C 0038C3CC 2D80C000 */  daddu      $16, $6, $0
    ...
    /* 1B7D60 0038C3E0 05008010 */  beqz       $4, .L0038C3F8
    /* 1B7D64 0038C3E4 0800BFFF */   sd        $31, 0x8($sp)
    /* 1B7D68 0038C3E8 46270E0C */  jal        func_00389D18
    /* 1B7D6C 0038C3EC 06A30046 */   mov.s     $f12, $f20
    /* 1B7D70 0038C3F0 02000010 */  b          .L0038C3FC
    /* 1B7D74 0038C3F4 2D184000 */   daddu     $3, $2, $0
.align 2
  .L0038C3F8:
    /* 1B7D78 0038C3F8 2D180000 */  daddu      $3, $0, $0
.align 2
  .L0038C3FC:
    /* 1B7D7C 0038C3FC 2A100302 */  slt        $2, $16, $3
    /* 1B7D80 0038C400 0D004010 */  beqz       $2, .L0038C438
    /* 1B7D84 0038C404 06A00046 */   mov.s     $f0, $f20
    /* 1B7D88 0038C408 00089044 */  mtc1       $16, $f1
    /* 1B7D8C 0038C40C 00000000 */  nop
    /* 1B7D90 0038C410 60088046 */  cvt.s.w    $f1, $f1
    /* 1B7D94 0038C414 00008344 */  mtc1       $3, $f0
...
.align 2
  .L0038C438:
    /* 1B7DB8 0038C438 0000B0DF */  ld         $16, 0x0($sp)
    /* 1B7DBC 0038C43C 0800BFDF */  ld         $31, 0x8($sp)
    /* 1B7DC0 0038C440 1800B5C7 */  lwc1       $f21, 0x18($sp)
    /* 1B7DC4 0038C444 1000B4C7 */  lwc1       $f20, 0x10($sp)
    /* 1B7DC8 0038C448 0800E003 */  jr         $31
