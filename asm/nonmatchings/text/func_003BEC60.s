...
glabel func_003BEC60
    ...
    /* 1EA5E4 003BEC64 00108044 */  mtc1       $zero, $f2
    /* 1EA5E8 003BEC68 0000B0FF */  sd         $s0, 0x0($sp)
    /* 1EA5EC 003BEC6C 06690046 */  mov.s      $f4, $f13
    /* 1EA5F0 003BEC70 0800B1FF */  sd         $s1, 0x8($sp)
    /* 1EA5F4 003BEC74 2D80A000 */  daddu      $s0, $a1, $zero
    /* 1EA5F8 003BEC78 3000B6E7 */  swc1       $f22, 0x30($sp)
    /* 1EA5FC 003BEC7C 2D888000 */  daddu      $s1, $a0, $zero
    /* 1EA600 003BEC80 2000B4E7 */  swc1       $f20, 0x20($sp)
    /* 1EA604 003BEC84 86650046 */  mov.s      $f22, $f12
    /* 1EA608 003BEC88 1000BFFF */  sd         $ra, 0x10($sp)
    /* 1EA60C 003BEC8C 2800B5E7 */  swc1       $f21, 0x28($sp)
    /* 1EA610 003BEC90 000000C6 */  lwc1       $f0, 0x0($s0)
    /* 1EA614 003BEC94 000021C6 */  lwc1       $f1, 0x0($s1)
...
.align 2
  .L003BECB8:
    /* 1EA638 003BECB8 00000DC6 */  lwc1       $f13, 0x0($s0)
    /* 1EA63C 003BECBC 00188044 */  mtc1       $zero, $f3
...
.align 2
  .L003BED7C:
    ...
    /* 1EA700 003BED80 2D200002 */   daddu     $a0, $s0, $zero
    /* 1EA704 003BED84 04000010 */  b          .L003BED98
    /* 1EA708 003BED88 000001C6 */   lwc1      $f1, 0x0($s0)
.align 2
  .L003BED8C:
    /* 1EA70C 003BED8C FEFA0E0C */  jal        func_003BEBF8
    /* 1EA710 003BED90 2D200002 */   daddu     $a0, $s0, $zero
    /* 1EA714 003BED94 000001C6 */  lwc1       $f1, 0x0($s0)
.align 2
  .L003BED98:
    ...
    /* 1EA728 003BEDA8 000036E6 */   swc1      $f22, 0x0($s1)
    /* 1EA72C 003BEDAC 000020C6 */  lwc1       $f0, 0x0($s1)
...
.align 2
  .L003BEDD4:
    /* 1EA754 003BEDD4 00000DE6 */  swc1       $f13, 0x0($s0)
    /* 1EA758 003BEDD8 000020C6 */  lwc1       $f0, 0x0($s1)
    /* 1EA75C 003BEDDC 00000D46 */  add.s      $f0, $f0, $f13
.align 2
  .L003BEDE0:
    /* 1EA760 003BEDE0 000020E6 */  swc1       $f0, 0x0($s1)
    /* 1EA764 003BEDE4 000000C6 */  lwc1       $f0, 0x0($s0)
.align 2
  .L003BEDE8:
    /* 1EA768 003BEDE8 0000B0DF */  ld         $s0, 0x0($sp)
    /* 1EA76C 003BEDEC 0800B1DF */  ld         $s1, 0x8($sp)
    /* 1EA770 003BEDF0 1000BFDF */  ld         $ra, 0x10($sp)
    ...
    /* 1EA780 003BEE00 0800E003 */  jr         $ra
