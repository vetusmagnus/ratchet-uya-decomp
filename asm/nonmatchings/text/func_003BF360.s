...
glabel func_003BF360
    ...
    /* 1EACE4 003BF364 0000B0FF */  sd         $s0, 0x0($sp)
    /* 1EACE8 003BF368 0800B1FF */  sd         $s1, 0x8($sp)
    /* 1EACEC 003BF36C 2D808000 */  daddu      $s0, $a0, $zero
    /* 1EACF0 003BF370 2D88A000 */  daddu      $s1, $a1, $zero
    /* 1EACF4 003BF374 1000BFFF */  sd         $ra, 0x10($sp)
    ...
    /* 1EAD08 003BF388 08000DC6 */  lwc1       $f13, 0x8($s0)
    /* 1EAD0C 003BF38C 06030046 */  mov.s      $f12, $f0
    /* 1EAD10 003BF390 8A220E0C */  jal        func_00388A28
    /* 1EAD14 003BF394 476B0046 */   neg.s     $f13, $f13
    /* 1EAD18 003BF398 040020E6 */  swc1       $f0, 0x4($s1)
    /* 1EAD1C 003BF39C 00000CC6 */  lwc1       $f12, 0x0($s0)
    /* 1EAD20 003BF3A0 8A220E0C */  jal        func_00388A28
    /* 1EAD24 003BF3A4 04000DC6 */   lwc1      $f13, 0x4($s0)
    ...
    /* 1EAD48 003BF3C8 08002CE6 */   swc1      $f12, 0x8($s1)
    /* 1EAD4C 003BF3CC 58220E0C */  jal        func_00388960
    /* 1EAD50 003BF3D0 07630046 */   neg.s     $f12, $f12
    /* 1EAD54 003BF3D4 08002CC6 */  lwc1       $f12, 0x8($s1)
    ...
    /* 1EAD68 003BF3E8 100001C6 */  lwc1       $f1, 0x10($s0)
    /* 1EAD6C 003BF3EC 140000C6 */  lwc1       $f0, 0x14($s0)
...
.align 2
  .L003BF40C:
    /* 1EAD8C 003BF40C 100015C6 */  lwc1       $f21, 0x10($s0)
    /* 1EAD90 003BF410 140016C6 */  lwc1       $f22, 0x14($s0)
.align 2
  .L003BF414:
    /* 1EAD94 003BF414 04002CC6 */  lwc1       $f12, 0x4($s1)
    ...
    /* 1EADB4 003BF434 18000DC6 */   lwc1      $f13, 0x18($s0)
    /* 1EADB8 003BF438 58220E0C */  jal        func_00388960
    /* 1EADBC 003BF43C 07630046 */   neg.s     $f12, $f12
    /* 1EADC0 003BF440 04002CC6 */  lwc1       $f12, 0x4($s1)
    ...
    /* 1EADD8 003BF458 180000C6 */  lwc1       $f0, 0x18($s0)
...
.align 2
  .L003BF474:
    ...
    /* 1EAE10 003BF490 00008044 */  mtc1       $zero, $f0
    ...
    /* 1EAE24 003BF4A4 000021E6 */   swc1      $f1, 0x0($s1)
...
.align 2
  .L003BF4D4:
    /* 1EAE54 003BF4D4 000020E6 */  swc1       $f0, 0x0($s1)
.align 2
  .L003BF4D8:
    /* 1EAE58 003BF4D8 0000B0DF */  ld         $s0, 0x0($sp)
    /* 1EAE5C 003BF4DC 0800B1DF */  ld         $s1, 0x8($sp)
    /* 1EAE60 003BF4E0 1000BFDF */  ld         $ra, 0x10($sp)
    ...
    /* 1EAE70 003BF4F0 0800E003 */  jr         $ra
